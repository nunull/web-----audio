var Tonal = function() {
    ...
    function n(e, n, t) {
        return function(...r) {
            return console.warn(`${e} is deprecated. Use ${n}.`),
            t.apply(this, r)
        }
    }
    function t(e) {
    ...
    function m(e) {
        const {step: n, alt: t, oct: r, dir: m=1} = e
          , i = o[n] + 7 * t;
        if (void 0 === r)
            return [m * i];
    ...
    function j(n) {
        return "string" == typeof n ? v[n] || (v[n] = function(e) {
            ...
            const {step: t, alt: r, oct: o=0, dir: a} = n;
            if (!a)
                return "";
            return (a < 0 ? "-" : "") + (t + 1 + 7 * o) + function(n, t) {
    ...
    function x(e) {
        const [n,t=0] = e;
        return j(c(7 * n + 12 * t < 0 ? [-n, -t, -1] : [n, t, 1]))
    }
    function O(e, n) {
        const t = M(e)
          , r = j(n);
    ...
    function T(e, n) {
        ...
        const o = t.coord
          , a = r.coord
          , m = a[0] - o[0];
        return x([m, 2 === o.length && 2 === a.length ? a[1] - o[1] : -Math.floor(7 * m / 12)]).name
    }
    var D = Object.freeze({
        __proto__: null,
        accToAlt: P,
    ...
    function $(e) {
        ...
        if (n.empty || !n.oct)
            return "";
        const {letter: t, acc: r, oct: o} = n;
        return ("b" === r[0] ? r.replace(/b/g, "_") : r.replace(/#/g, "^")) + (o > 4 ? t.toLowerCase() : t) + (5 === o ? "" : o > 4 ? w("'", o - 5) : w(",", 4 - o))
    }
    var q = {
    ...
    var E = Object.freeze({
        ...
        permutations: function e(n) {
            return 0 === n.length ? [[]] : e(n.slice(1)).reduce((e,t)=>e.concat(n.map((e,r)=>{
                const o = t.slice();
                return o.splice(r, 0, n[0]),
                o
            }
            )), [])
        },
    ...
    const ie = n("ChordType.chordType", "ChordType.get", me);
    function ce() {
        return oe.slice()
    }
    const se = n("ChordType.entries", "ChordType.all", ce);
    function ue(e, n, t) {
        const r = function(e) {
        ...
        ae[o.setNum] = o,
        ae[o.chroma] = o,
        o.aliases.forEach(e=>function(e, n) {
            ae[n] = e
        }(o, e))
    }
    [["1P 3M 5P", "major", "M ^ "], ["1P 3M 5P 7M", "major seventh", "maj7 Δ ma7 M7 Maj7 ^7"], ["1P 3M 5P 7M 9M", "major ninth", "maj9 Δ9 ^9"], ["1P 3M 5P 7M 9M 13M", "major thirteenth", "maj13 Maj13 ^13"], ["1P 3M 5P 6M", "sixth", "6 add6 add13 M6"], ["1P 3M 5P 6M 9M", "sixth/ninth", "6/9 69 M69"], ["1P 3M 6m 7M", "major seventh flat sixth", "M7b6 ^7b6"], ["1P 3M 5P 7M 11A", "major seventh sharp eleventh", "maj#4 Δ#4 Δ#11 M7#11 ^7#11 maj7#11"], ["1P 3m 5P", "minor", "m min -"], ["1P 3m 5P 7m", "minor seventh", "m7 min7 mi7 -7"], ["1P 3m 5P 7M", "minor/major seventh", "m/ma7 m/maj7 mM7 mMaj7 m/M7 -Δ7 mΔ
    oe.sort((e,n)=>e.setNum - n.setNum);
    var le = {
        names: function() {
            return oe.map(e=>e.name).filter(e=>e)
        },
        symbols: function() {
            return oe.map(e=>e.aliases[0]).filter(e=>e)
        },
        get: me,
        all: ce,
        add: ue,
    ...
    let Pe = []
      , Me = {};
    function fe() {
        return Pe.map(e=>e.name)
    }
    function pe(e) {
        return Me[e] || de
    }
    const he = n("ScaleDictionary.scaleType", "ScaleType.get", pe);
    function ye() {
        return Pe.slice()
    }
    const be = n("ScaleDictionary.entries", "ScaleType.all", ye);
    function ge(e, n, t=[]) {
        const r = {
            ...J(e),
            name: n,
        ...
        Me[r.setNum] = r,
        Me[r.chroma] = r,
        r.aliases.forEach(e=>function(e, n) {
            Me[n] = e
        }(r, e)),
        r
    }
    ...
    function Ie(e) {
        const [n,t,r,o] = p(e);
        return "" === n ? ["", e] : "A" === n && "ug" === o ? ["", "aug"] : o || "4" !== r && "5" !== r ? je.test(r) ? [n + t, r + o] : [n + t + r, o] : [n + t, r]
    }
    function Ne(e) {
        if ("" === e)
            return ve;
    ...
    function xe(e, n, t) {
        const r = me(e)
          , o = M(n || "")
          , a = M(t || "");
        if (r.empty || n && o.empty || t && a.empty)
            return ve;
        const m = T(o.pc, a.pc)
    ...
    var Oe = {
        ...
        detect: function(e) {
            ...
            return 0 === M.length ? [] : function(e, n) {
                const t = e[0]
                  ...
                  , o = (e=>{
                    const n = e.reduce((e,n)=>{
                        const t = M(n).chroma;
                        return void 0 !== t && (e[t] = e[t] || M(n).name),
                        e
                    }
                    , {});
                    return e=>n[e]
                ...
                return a.forEach((e,a)=>{
                    ce().filter(n=>n.chroma === e).forEach(e=>{
                        const i = e.aliases[0]
                          , c = o(a);
                        a !== r ? m.push({
                            weight: .5 * n,
        ...
        chordScales: function(e) {
            const n = ee(Ne(e).chroma);
            return ye().filter(e=>n(e.chroma)).map(e=>e.name)
        },
        extended: function(e) {
            const n = Ne(e)
              , t = ee(n.chroma);
            return ce().filter(e=>t(e.chroma)).map(e=>n.tonic + e.aliases[0])
        },
        reduced: function(e) {
            const n = Ne(e)
              , t = Z(n.chroma);
        ...
        chord: n("Chord.chord", "Chord.get", Ne)
    };
    const Te = [];
    ...
    const we = /^([^.]+)(\.*)$/;
    function Se(e) {
        const [n,t,r] = we.exec(e) || []
          , o = Te.find(e=>e.shorthand === t || e.names.includes(t));
        if (!o)
            return De;
    ...
    var Ce = {
        names: function() {
            return Te.reduce((e,n)=>(n.names.forEach(n=>e.push(n)),
            e), [])
        },
        shorthands: function() {
            return Te.map(e=>e.shorthand)
        },
        get: Se,
        value: e=>Se(e).value,
        fraction: e=>Se(e).fraction
    };
    const Ve = j;
    function $e(e) {
        const n = j(e);
    ...
    const qe = [1, 2, 2, 3, 3, 4, 5, 5, 6, 6, 7, 7]
      , ke = "P m M m M P d P m M m M".split(" ");
    const Ee = T
      , _e = Ue((e,n)=>[e[0] + n[0], e[1] + n[1]])
      , Fe = Ue((e,n)=>[e[0] - n[0], e[1] - n[1]]);
    function ze(e, n) {
        const t = Ve(e);
        if (t.empty)
            return "";
        const [r,o,a] = t.coord;
        return x([r + n, o, a]).name
    }
    var Re = {
        names: function() {
    ...
    const Ke = Math.log(2)
      , Le = Math.log(440);
    function He(e) {
        const n = 12 * (Math.log(e) - Le) / Ke + 69;
        return Math.round(100 * n) / 100
    }
    const Je = "C C# D D# E F F# G G# A A# B".split(" ")
      , Qe = "C Db D Eb E F Gb G Ab A Bb B".split(" ");
    function We(e, n={}) {
        if (isNaN(e) || e === -1 / 0 || e === 1 / 0)
            return "";
        e = Math.round(e);
        const t = (!0 === n.sharps ? Je : Qe)[e % 12];
        if (n.pitchClass)
            return t;
    ...
    const Ye = ["C", "D", "E", "F", "G", "A", "B"]
      , Ze = e=>e.name
      , en = e=>e.map(M).filter(e=>!e.empty);
    const nn = M;
    const tn = O
      , rn = e=>n=>tn(n, e)
      , on = e=>n=>tn(e, n);
    ...
    var un = {
        names: function(e) {
            return void 0 === e ? Ye.slice() : Array.isArray(e) ? en(e).map(Ze) : []
        },
        get: nn,
        name: e=>nn(e).name,
        pitchClass: e=>nn(e).pc,
        accidentals: e=>nn(e).acc,
        octave: e=>nn(e).oct,
        midi: e=>nn(e).midi,
        ascending: mn,
        ...
        simplify: e=>{
            const n = nn(e);
            return n.empty ? "" : We(n.midi || n.chroma, {
                sharps: n.alt > 0,
                pitchClass: null === n.midi
            })
        }
        ,
        enharmonic: function(e, n) {
            const t = nn(e);
            if (t.empty)
                return "";
            const r = nn(n || We(t.midi || t.chroma, {
                sharps: t.alt < 0,
                pitchClass: !0
            }));
            if (r.empty || r.chroma !== t.chroma)
                return "";
            if (void 0 === t.oct)
                return r.pc;
    ...
    const ln = {
      ...
      , dn = {};
    function Pn(e) {
        return "string" == typeof e ? dn[e] || (dn[e] = function(e) {
            const [n,t,r,o] = (a = e,
            fn.exec(a) || ["", "", "", ""]);
            var a;
            if (!r)
        ...
        }(e)) : "number" == typeof e ? Pn(hn[e] || "") : r(e) ? Pn(d((n = e).alt) + hn[n.step]) : t(e) ? Pn(e.name) : ln;
        var n
    }
    const Mn = n("RomanNumeral.romanNumeral", "RomanNumeral.get", Pn);
    const fn = /^(#{1,}|b{1,}|x{1,}|)(IV|I{1,3}|VI{0,2}|iv|i{1,3}|vi{0,2})([^IViv]*)$/;
    const pn = "I II III IV V VI VII"
      , hn = pn.split(" ")
      , yn = pn.toLowerCase().split(" ");
    var bn = {
        names: function(e=!0) {
            return (e ? hn : yn).slice()
        },
        get: Pn,
        romanNumeral: Mn
    };
    const gn = Object.freeze([])
      ...
      , jn = {
        ...
        minorRelative: "",
        scale: gn,
        secondaryDominants: gn,
        secondaryDominantsMinorRelative: gn,
        substituteDominants: gn,
        substituteDominantsMinorRelative: gn
    }
      , In = {
        ...An,
        type: "minor",
      ...
      , Nn = (e,n,t="")=>n.map((n,r)=>`${e[r]}${t}${n}`);
    function xn(e, n, t, r) {
        return o=>{
            const a = e.map(e=>Pn(e).interval || "")
              , m = a.map(e=>O(o, e));
            return {
                tonic: o,
                grades: e,
    ...
    const On = (e,n)=>{
      ...
      , Tn = xn("I II III IV V VI VII".split(" "), "maj7 m7 m7 maj7 7 m7 m7b5".split(" "), "T SD T SD D T D".split(" "), "major,dorian,phrygian,lydian,mixolydian,minor,locrian".split(","))
      ...
      , wn = xn("I II bIII IV V bVI VII".split(" "), "mMaj7 m7b5 +maj7 m7 7 maj7 o7".split(" "), "T SD T SD D SD D".split(" "), "harmonic minor,locrian 6,major augmented,lydian diminished,phrygian dominant,lydian #9,ultralocrian".split(","))
      , Sn = xn("I II bIII IV V VI VII".split(" "), "m6 m7 +maj7 7 7 m7b5 m7b5".split(" "), "T SD T SD D  ".split(" "), "melodic minor,dorian b2,lydian augmented,lydian dominant,mixolydian b6,locrian #2,altered".split(","));
    var Cn = {
        majorKey: function(e) {
            const n = M(e).pc;
            if (!n)
            ...
            const t = Tn(n)
              ...
              , o = n=>{
                const t = Pn(n);
                return t.empty ? "" : O(e, t.interval) + t.chordType
            }
            ;
            return {
                ...t,
                type: "major",
                minorRelative: O(n, "-3m"),
                alteration: r,
                keySignature: d(r),
    ...
    const Vn = [[0, 2773, 0, "ionian", "", "Maj7", "major"], [1, 2902, 2, "dorian", "m", "m7"], [2, 3418, 4, "phrygian", "m", "m7"], [3, 2741, -1, "lydian", "", "Maj7"], [4, 2774, 1, "mixolydian", "", "7"], [5, 2906, 3, "aeolian", "m", "m7", "minor"], [6, 3434, 5, "locrian", "dim", "m7b5"]]
      , $n = {
        ...U,
        name: "",
        alt: 0,
      ...
      , qn = Vn.map((function(e) {
        const [n,t,r,o,a,m,i] = e
          , c = i ? [i] : []
          , s = Number(t).toString(2);
        return {
            empty: !1,
            intervals: X(s),
            modeNum: n,
      ...
      , kn = {};
    function En(e) {
        return "string" == typeof e ? kn[e.toLowerCase()] || $n : e && e.name ? En(e.name) : $n
    }
    qn.forEach(e=>{
        kn[e.name] = e,
        e.aliases.forEach(n=>{
    ...
    const _n = n("Mode.mode", "Mode.get", En);
    function Fn() {
        return qn.slice()
    }
    const zn = n("Mode.mode", "Mode.all", Fn);
    function Rn(e) {
        return (n,t)=>{
            const r = En(n);
            if (r.empty)
    ...
    function Un(e, n) {
        const t = En(n)
          , r = En(e);
        return t.empty || r.empty ? "" : $e(ze("1P", r.alt - t.alt))
    }
    var Bn = {
        get: En,
        names: function() {
            return qn.map(e=>e.name)
        },
        all: Fn,
        distance: Un,
        ...
        notes: function(e, n) {
            return En(e).intervals.map(e=>O(n, e))
        },
        triads: Rn(Vn.map(e=>e[4])),
        seventhChords: Rn(Vn.map(e=>e[5])),
        entries: zn,
        mode: _n
    };
    var Gn = {
        fromRomanNumerals: function(e, n) {
            return n.map(Pn).map(n=>O(e, j(n)) + n.chordType)
        },
        toRomanNumerals: function(e, n) {
            return n.map(n=>{
                const [t,r] = Ie(n);
                return Pn(j(T(e, t))).name + r
            }
            )
        }
    };
    ...
    function Qn(e) {
        const n = Array.isArray(e) ? e : Jn(e)
          , t = M(n[0]).name
          , r = pe(n[1]);
        if (r.empty)
            return Hn;
        const o = r.name
          , a = t ? r.intervals.map(e=>O(t, e)) : []
          , m = t ? t + " " + o : o;
        return {
            ...r,
            name: m,
    ...
    var Xn = {
        ...
        reduced: function(e) {
            const n = Z(Qn(e).chroma);
            return ye().filter(e=>n(e.chroma)).map(e=>e.name)
        },
        scaleChords: function(e) {
            const n = Z(Qn(e).chroma);
            return ce().filter(e=>n(e.chroma)).map(e=>e.aliases[0])
        },
        scaleNotes: Wn,
        tokenize: Jn,
        rangeOf: function(e) {
            const n = function(e) {
                const n = Array.isArray(e) ? Wn(e) : Qn(e).notes
                  , t = n.map(e=>M(e).chroma);
                return e=>{
                    const r = "number" == typeof e ? e : M(e).height;
                    if (void 0 === r)
                        return;
                    const o = r % 12
                      , a = Math.floor(r / 12) - 1
                      , m = t.indexOf(o);
                    return -1 !== m ? n[m] + a : void 0
                }
            }(e);
            return (e,t)=>{
                const r = M(e).height
        ...
        scale: n("Scale.scale", "Scale.get", Qn)
    };
    const Yn = {
        empty: !0,
        name: "",
      ...
      , Zn = ["4/4", "3/4", "2/4", "2/2", "12/8", "9/8", "6/8", "3/8"];
    const et = /^(\d?\d(?:\+\d)*)\/(\d)$/
      , nt = new Map;
    function tt(e) {
        if ("string" == typeof e) {
            const [n,t,r] = et.exec(e) || [];
            return tt([t, r])
        }
        const [n,t] = e
          , r = +t;
    ...
    var ot, at, mt = (function(e, n) {
        !function(e, n, t, r, o, a, m, i, c, s, u, l, d, P, M, f, p, h, y, b) {
            ...
            Object.keys(m).forEach((function(n) {
                "default" !== n && Object.defineProperty(e, n, {
                    enumerable: !0,
                    get: function() {
                        return m[n]
                    }
            ...
            e.Core = O,
            Object.defineProperty(e, "DurationValue", {
                enumerable: !0,
                get: function() {
                    return T.default
                }
        ...
        }(n, q, E, Oe, le, R, D, Ce, Re, Cn, Xe, Bn, un, te, Gn, Ln, bn, Xn, Ae, rt)
    }(ot = {
        exports: {}
    }, ot.exports),
    ot.exports);
    return (at = mt) && at.__esModule && Object.prototype.hasOwnProperty.call(at, "default") ? at.default : at
}();
